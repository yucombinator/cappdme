...
expiration date and total cap before a link stops working and is then deleted from the database. It also has a RESTful API to allow quick link creation.
